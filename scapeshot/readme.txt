...
* Bug Fixed: Testimonial Custom Post Type Archive Title and Content issue with Jetpack
* Updated: WordPress 7.0 ready

= 1.2.5 (Released: December 10, 2025) =
* Bug Fixed: Deprecated Function WP_Dependencies-add_data() warning after WordPress update 6.9
* Updated: WordPress 6.9 ready

= 1.2.4 (Released: May 31, 2025) =
* Added: Bluesky, X.com, Phone, Feed icon
* Updated: WordPress 6.8 ready

= 1.2.3 (Released: June 13, 2024) =
* Updated: WordPress 6.5 ready

= 1.2.2 (Released: February 26, 2024) =
* Removed: Depreciated Instagram Feed Plugin recommendation
* Updated: WordPress 6.4 ready

= 1.2.1 (Released: June 16, 2023) =
* Bug Fixed: Removed unnecessary code from comments in custom-header.php
* Updated: WordPress 6.2 ready

= 1.2 (Released: August 23, 2022) =
...
ScapeShot WordPress Theme, Copyright 2012-2026 Catchthemes.com
